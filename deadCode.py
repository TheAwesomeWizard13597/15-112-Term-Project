...
def initDead(app):
    app.restartButtonDead = (50, app.height/2, app.width / 2 - 50, app.height - 100, 'Restart!')
    app.respawnButton = (app.width / 2 + 50, app.height / 2, app.width - 50, app.height - 100, 'Respawn!')
    app.dead = False
